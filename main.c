...
#define AUX LATAbits.LATA7
#define AUX2 LATBbits.LATB15
#define AUX3 LATBbits.LATB13
#define TRIS_AUX TRISAbits.TRISA7
#define TRIS_AUX2 TRISBbits.TRISB15
#define TRIS_AUX3 TRISBbits.TRISB13
